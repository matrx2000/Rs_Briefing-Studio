...
<translations>
  ...
  <string key="ui.textsize"><en>Text size</en><de>Textgröße</de><it>Dimensione testo</it><hr>Veličina teksta</hr></string>
  ...
  <string key="index.tip"><en>Tip: every briefing is two A3-portrait pages — page 1 is the dashboard you read in 90 seconds, page 2 is the depth that backs it up.</en><de>Tipp: Jedes Briefing besteht aus zwei A3-Hochformatseiten — Seite 1 ist das Dashboard, das Sie in 90 Sekunden lesen, Seite 2 die Tiefe, die es untermauert.</de><it>Suggerimento: ogni briefing è composto da due pagine A3 verticali — la pagina 1 è il dashboard che leggi in 90 secondi, la pagina 2 è la profondità che la sostiene.</it><hr>Savjet: svaki izvještaj sastoji se od dvije A3-portretne stranice — stranica 1 je nadzorna ploča koju pročitate u 90 sekundi, stranica 2 je dubina koja ju podupire.</hr></string>
